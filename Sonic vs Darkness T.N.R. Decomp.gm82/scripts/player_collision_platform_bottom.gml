/*
*       player_collision_platform_bottom( x, y, angle, mask );
*
*   =============================================
*
...
*/
    ...
    */
    ...
    temporal_mask2   =   mask_index;
    mask_index      =   argument3;

    // Test collision
    collision_test2  =   place_meeting(floor(argument0 + sin(degtorad(argument2)) * 11),
                                       floor(argument1 + cos(degtorad(argument2)) * 11), objPlatform);

    // Set to the old mask
    mask_index      =   temporal_mask2;

    // Calculate the direction
    return  collision_test2;
