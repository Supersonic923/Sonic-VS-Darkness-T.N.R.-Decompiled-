switch(string_char_at(str_,chr_+skipchr))
{
  ...
  case "<": sound_type=sndDialogueTalk; command=1; skipchr+=1; break;
  case "_": sound_type=sndDialogueTalk; command=1; skipchr+=1; break;
  case ">": sound_type=sndDialogueTalk; command=1; skipchr+=1; break;
  case "@": sound_type=sndDialogueTalk; command=1; skipchr+=1; break;
  case "~": if (shaking==0) {shaking=1} else {shaking=0}; command=1; skipchr+=1; break;
  case "`": alarm[1]=20; command=1; skipchr+=1; break;
  case "]": alarm[1]=40; command=1; skipchr+=1; break;
...
if alarm[1]<1 && skipping=false
{
  switch(speed_mode)
  {
    case 1: alarm[1]=10; break;
    case 2: alarm[1]=5; break;
    case 3: alarm[1]=2; break;
  }
}
