/*
*       player_get_angle( x, y, angle, land check );
*
*   =============================================
*
...
*/
    ...
    */
    ...
    {
        if (player_collision_platform(floor(point_1_x), floor(point_1_y), layer, argument3) == false)
        {
            point_1_x   +=  sin(degtorad(argument2));
            point_1_y   +=  cos(degtorad(argument2));
        }
        if (player_collision_platform(floor(point_2_x), floor(point_2_y), layer, argument3) == false)
        {
