...
if(joystick_exists(1)==true) && global.ps3=false
{
        // find windows name for the first controller
        cont_name[0]=joystick_name(1);
        //set the face buttons
        button_a[0]=joystick_check_button(1,1); //(1,1)
        button_b[0]=joystick_check_button(1,2); //(1,2)
        button_x[0]=joystick_check_button(1,3); //(1,3)
        button_y[0]=joystick_check_button(1,4); //(1,4)
        button_back[0]=joystick_check_button(1,7); //(1,7)
        button_start[0]=joystick_check_button(1,8); //(1,8)
        // set the dpad
