/*
*   player_collision_left_edge(x,y,angle,land check)
*
*   =============================================
*
...
*/
    ...
    */
    ...
    // Stops player from flickering the ground variable between true and false
    /*if angle=0 && x_speed=0
    {
        mask_index      =   maskEdgeFix;
        sprite_index    =   maskEdgeFix;
        image_index     =   0;
    }*/
    //else{
