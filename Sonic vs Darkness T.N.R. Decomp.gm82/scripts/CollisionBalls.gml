//CollisionBalls()
//exchange velocities only
//Call in collision event
//Both objects need a m_Mass variable
//Both objects should have centered origin sprites
//both objects should be non solid

// argBalls must be going towards one another. Use Towards() and JustHit() to check
...
vx1 = x1-argBall1.xprevious;
vy1 = y1-argBall1.yprevious;

var vx2;
var vy2;

vx2 = x2-argBall2.xprevious;
vy2 = y2-argBall2.yprevious;
...
argBall1.hspeed= vx1*2;
argBall1.vspeed= vy1*2;
//argBall2.hspeed= vx2;
//argBall2.vspeed= vy2;
//argBall1.speed*= argBall2.m_Bouncy
//argBall2.speed*= argBall1.m_Bouncy
