...
*/
    ...
    // Idle animation
    animation_idle_start  = 266;
    animation_idle_end    = 273;
    animation_idle_loop   = 266;
    ...
    animation_idle_wait_start  = 340;
    animation_idle_wait_end    = 364;
    animation_idle_wait_loop   = 357;
    ...
    animation_crouchdown_start  = 256;
    animation_crouchdown_end    = 265;
    animation_crouchdown_loop   = 258;
    animation_crouchdown_speed  = 0.15;
    animation_crouchdown_repeat = true;
    ...
    animation_jumping_speed  = 0.30;
    animation_jumping_repeat = true;
    animation_jumping_linked_to = "(none)";

    //Jump 2 animation
    animation_jumping2_start  = 76;
    animation_jumping2_end    = 79;
    animation_jumping2_loop   = 76;
    animation_jumping2_speed  = 0.40;
    animation_jumping2_repeat = true;
    animation_jumping2_linked_to = "(none)";

    //Climb Rise animation
    animation_climbrise_start = 365;
    animation_climbrise_end   = 374;
    animation_climbrise_loop  = 365;
    animation_climbrise_speed = .2;
    animation_climbrise_repeat = false;
    animation_climbrise_linked_to = "(none)";

    //Fly animation
    animation_fly_start  = 225;
    animation_fly_end    = 232;
    animation_fly_loop   = 225;
    animation_fly_speed  = 0.45;
    animation_fly_repeat = true;
    animation_fly_linked_to = "(none)";

    //Tired animation
    animation_tired_start  = 233;
    animation_tired_end    = 238;
    animation_tired_loop   = 235;
    animation_tired_speed  = 0.2;
    animation_tired_repeat = true;
    animation_tired_linked_to = "(none)";

    //Tired Swim animation
    animation_tired2_start  = 247;
    animation_tired2_end    = 255;
    animation_tired2_loop   = 248;
    animation_tired2_speed  = 0.2;
    animation_tired2_repeat = true;
    animation_tired2_linked_to = "(none)";

    //Attack animation
    animation_attack_start  = 118;
    animation_attack_end    = 126;
    animation_attack_loop   = 118;
    animation_attack_speed  = 0.45;
    animation_attack_repeat = false;
    animation_attack_linked_to = "idle";

    //Tornado animation
    animation_attack2_start  = 274;
    animation_attack2_end    = 286;
    animation_attack2_loop   = 279;
    animation_attack2_speed  = 0.45;
    animation_attack2_repeat = true;
    animation_attack2_linked_to = "(none)";

    //Dummy animation
    animation_attack3_start  = 308;
    animation_attack3_end    = 323;
    animation_attack3_loop   = 323;
    animation_attack3_speed  = 0.3;
    animation_attack3_repeat = false;
    animation_attack3_linked_to = "idle";

    //Dizzy animation
    animation_dizzy_start  = 287;
    animation_dizzy_end    = 302;
    animation_dizzy_loop   = 295;
    animation_dizzy_speed  = 0.2;
    animation_dizzy_repeat = 2;
    animation_dizzy_linked_to = "dizzy2";

    //Dizzy 2 animation
    animation_dizzy2_start  = 303;
    animation_dizzy2_end    = 307;
    animation_dizzy2_loop   = 304;
    animation_dizzy2_speed  = 0.3;
    animation_dizzy2_repeat = 2;
    animation_dizzy2_linked_to = "idle";

    //Swim animation
    animation_swim_start  = 239;
    animation_swim_end    = 246;
    animation_swim_loop   = 239;
    animation_swim_speed  = 0.2;
    ...
    // Flyfall animation
    animation_flyfall_start  = 110;
    animation_flyfall_end    = 117;
    animation_flyfall_loop   = 114;
    animation_flyfall_speed  = 0.3;
    animation_flyfall_repeat = true;
    animation_flyfall_repeat_times = -1;
    animation_flyfall_linked_to = "(none)";
    ...
    //Pole animation
    animation_pole_start  = 375;
    animation_pole_end    = 378;
    animation_pole_loop   = 375;
    ...
    //Pole 2 animation
    animation_pole2_start  = 379;
    animation_pole2_end    = 382;
    animation_pole2_loop   = 379;
    ...
    //Falling Frontwards
    animation_fallingfront_start = 324;
    animation_fallingfront_end   = 331;
    animation_fallingfront_loop  = 324;
    animation_fallingfront_speed = .25;
    animation_fallingfront_repeat = true;
    animation_fallingfront_linked_to = "(none)";

    //Falling Backwards
    animation_fallingback_start = 332;
    animation_fallingback_end   = 339;
    animation_fallingback_loop  = 332;
...
*/
    ...
    sound_stop(sndTailsRun)
    sound_stop(sndTailsFly)
    if transform=false{
    var camtrans;
    camtrans=instance_create(x,y,objTailsDie);
...
*/
 ...
 if objHandle!=noone
 {
        if action=action_stomping || instance_exists(objBoostPar) || abs(x_speed)>10
        with objHandle
        instance_destroy()
 }
        ...
        if (ground == false)
        {
            y   +=  y_speed;
                ...
                if (y_speed >= 0 && player_collision_bottom( x, y, 0, maskBig ) == true) && phase=false
                {
                    ...
                    if (action == action_jumping || action == action_sideroll || action=action_fly || action == action_hang)
                    {
                        action = action_normal;
                        sound_play(landsnd)
                    }
...
// gameplay
        ...
        if ( action == action_normal || action == action_jumping  || action == action_fly || action == action_sliding_jump || action == action_pushing || action == action_spring_jump || action == action_super_spring_jump || action=action_dive
         || ((shield == 3 || shield == 4) && action == action_shield) || action == action_corkscrew  || action == action_corkscrew_roll || slide=1) && checknend=false && pauseplay=false && goal=false
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if animation!="attack" && animation!="attack2" && animation!="attack3" && animation!="dizzy" && animation!="dizzy2"
                        x_speed -= x_acceleration;
                    }
                }
            }
        ...
        else if phase=false && animation!="climbrise"
        {
            // Add gravity
        ...
        //--------Fly---------------------------------------------------
        if goal=false && pauseplay=false && checknend=false
        {
            if key_action_pressed && ground=false && (action=action_jumping || animation="fly"  || animation="swim")
            ...
            && (phase=false && visible=true)
            {
                ...
                else if animation!="tired" && animation!="tired2"
                    flydelay=15
            }
            if action=action_fly && flytime>0
            {
                if underwater=false
                {
                    if animation!="fly"
                    {
                        sound_loop(sndTailsFly)
                        animation="fly"
                    }
                }
            ...
            if animation="fly" || animation="swim"
            {
                if y_speed>5
                y_speed=5
                if flydelay>0
        ...
        if (animation="tired" || animation="tired2") && y_speed>6
            y_speed=6
        ...
        if ground=true && action=action_fly
        action=action_normal
        ...
        if goal=false && pauseplay=false && checknend=false
        {
            if (tornadodelay=0 || tornadotime=0) && animation="attack2"{
            action=action_normal
            animation="dizzy"}
        }
        ...
        if goal=false && pauseplay=false && checknend=false
        {
            if animation="attack3" && floor(animation_frame)=317 && toss=false{
            sound_play(sndTailsAttack)
            sound_play(sndDummyRingLose)
            instance_create(x,y,objSpinGlow)
            objPlayer.rstrenght=.8
            objPlayer.hitrumble=10
            if global.Rings>=5
            c=choose(3,4,5)
            else if global.Rings=4
            c=choose(3,4)
            ...
            {
                if global.Rings>c{
                instance_create(x,y,objDummyRing)
                global.Rings-=c}
            }
            toss=true}
        ...
        action=action_normal)//action!=action_grind && action!=action_look_up && action!=action_crouch_down && action!=action_elevator && action!=action_charge && action!=action_spindash
         //&& animation!="attack" && animation!="attack2" && animation!="attack3" && animation!="dizzy" && animation!="dizzy2")
        {
                if key_left_pressed{
        ...
        (action == action_hang && (hang=0 || hang=1 || hang=2 || hang=5) && canmove=true)
         || action == action_corkscrew_roll || action=action_rocket)) || (action == action_pole_hang && !key_down)
          ...
          && action!=action_elevator && action!=action_pipe && action!=action_siderun && action!=action_enter && animation!="attack" && animation!="attack2"
          && animation!="attack3" && animation!="dizzy" && animation!="dizzy2")
        ...
        if ( action == action_look_up )
        {
            ...
            // crouch down token.
            if (ground == true && x_speed == 0 && key_up_direct && action == action_normal) && animation!="attack" && animation!="attack2" 
            && animation!="attack3" && animation!="dizzy" && animation!="dizzy2" && pauseplay=false && goal=false && dontlook=false
                action = action_look_up;
        ...
        if ( action == action_crouch_down )
        {
            ...
            // crouch down. while the character is quiet, on the ground and pressing down, activate the
            // crouch down token.
            if (ground == true && x_speed == 0 && key_down_direct && action == action_normal) && animation!="attack" && animation!="attack2"
            && animation!="attack3" && animation!="dizzy" && animation!="dizzy2" && pauseplay=false  && goal=false  && wheel=false
...
*/
        ...
        if (objHandle != noone)
        {
            ...
            else
            {
                ...
                || (animation == "homeroll" || animation == "crouch_slide" || animation=="home" || animation="jumping2" || (animation="fly"&& y>objHandle.y))
...
&& action!=action_righttrick && action!=action_uptrick && action!=action_downtrick && action!=action_dive && action!=action_corkscrewdown
&& action!=action_climbrise) && action!=action_fly && action!=action_pipe && action!=action_pole_hang
{
    if y_speed>0 && animation!="walljump" && animation!="flyfall" && (animation!="breath" && animation_frame!=186) && (animation!="flightdash" || !instance_exists(objBBoost))
        animation="airfall";
...
applies_to=self
*/
if (((path_index=pathtrick1 || path_index=pathtrick2) && path_speed=10) || lightdash=true || action=action_soaring || action=action_flightdash || animation="fly"
...
if ground=true || action=action_siderun
{
            ...
            floor(animation_frame)=22 || floor(animation_frame)=46 || floor(animation_frame)=42
    ...
    if  (player_collision_watr( x, y, angle, objWaterSolid ) == true) && (action=action_skid || action=action_skid2 || action=action_rolling || animation="slide"
        || animation="crouch_slide" || animation="spinboost" || animation="sprinting")
    {
        if abs(x_speed)>=18{
    ...
    || action=action_rolling || animation="spinboost" || animation="crouch_slide" || animation="sprinting")
    {
        if abs(x_speed)>=18{
        if !instance_exists(objWaterSkidL){
        with objWaterSkid
...
if (player_collision_watr( x, y, angle, objWaterSolid )!=true) && phase=false
{
    ...
    || floor(animation_frame)=159 || floor(animation_frame)=163 || floor(animation_frame)=169 ||
    ...
    (floor(animation_frame)=46 || floor(animation_frame)=42 && pushing=true)
    {
        if stopdust=true
        {
...
*/
    ...
    if ( (action == action_normal || action=action_elevator) && ground == true) && animation!="attack2" && animation!="dizzy"
    {
        ...
        animation="ground_roll"}
            ...
            animation = "joging";
        else if ( abs(x_speed) > 5 && abs(x_speed) <= 9 && animation != "running")
            animation = "running";
        else if ( abs(x_speed) > 9 && animation != "sprinting" && animation!="spinboost"){
            animation = "sprinting";    if !sound_isplaying(sndTailsRun) sound_loop(sndTailsRun)}
        else if ( x_speed == 0 && animation != "idle" && animation != "idle_wait" && animation!="attack" && animation!="attack2"
         && animation!="dizzy" && animation!="dizzy2" && animation != "edge" && animation != "gresult" && animation != "bresult" &&
        animation != "attack3"){
            animation = "idle";}
        ...
        if ( action == action_jumping && animation != "jumping")
            animation = "jumping";
        if ( action == action_fly && animation != "fly" && animation != "swim" && animation != "tired" && animation != "tired2")
            animation = "fly";
...
if floor(animation_frame)=292 && (tornadotime>0 || abs(x_speed)>0)
animation="idle"
...
animation = "charge";
if ( action == action_climbrise && animation != "climbrise")
animation = "climbrise";
...
*/
    ...
    {
            image_alpha=0.5
            if action=action_soaring || action=action_dive || action=action_jumping
            draw_sprite_ext(sprTails, floor(animation_frame), floor(x), floor(y), image_xscale, image_yscale, image_angle, image_blend, hurt);
            else
            draw_sprite_ext(sprTails, floor(animation_frame), floor(x), floor(y), animation_direction, 1, angle, image_blend, hurt);
    }
    ...
    {
        if action=action_soaring || action=action_dive || action=action_jumping
        draw_sprite_ext(sprTails, floor(animation_frame), floor(x), floor(y), image_xscale, image_yscale, image_angle, image_blend, 1);
        else
        draw_sprite_ext(sprTails, floor(animation_frame), floor(x), floor(y), animation_direction, 1, angle, image_blend, 1);
...
applies_to=self
invert=0
arg0=checknend=false && action!=action_elevator && goal=false && pauseplay=false
*/
/*"/*'/**//* YYD ACTION
lib_id=1
action_id=603
...
{
    // Tail Swipe Attack
    if abs(x_speed)<4 && ground=true && slide=0 && action=action_normal && animation!="attack2" && animation!="attack3" && animation!="dizzy" && animation!="dizzy2"
    {
        if (!key_down && !key_up){
        x_speed=0
        if animation!="attack"{
        ...
        objPlayer.hitrumble=10
        animation="attack"
        c=instance_create(x,y,objTailWip)
        c.image_angle=angle
        c.image_xscale=animation_direction
        sound_play(sndTailWip)}}
    }

    // Dummy Rings Attack
    if abs(x_speed)<3 && ground=true && slide=0 && animation!="attack" && animation!="attack2" && animation!="dizzy" && animation!="dizzy2" && instance_number(objDummyRing)<16 && global.Rings>2
    {
        if (key_down){
        x_speed=0
        if animation!="attack3"{
    ...
    // Tornado Attack
    if (abs(x_speed)>=4 || key_up)
    {
        if ground=true && slide=0 && animation!="attack" && animation!="attack3" && groll=false && animation!="dizzy" && animation!="dizzy2"
        {
            if (!key_down){
            if animation!="attack2"{
            tornadotime=180
            action=action_normal
            animation="attack2"
            sound_stop(sndTailsTornadoLp)
            sound_play(sndTailsTornado)
            sound_loop(sndTailsTornadoLp)
            instance_create(x,y,objTailsTornado)}}
        }
    }
    if animation="attack2"
    tornadodelay=40
...
animation="flyfall"
flytime=0
v=instance_create(x,y,objSpinGlow)
v.image_alpha=.6
if y_speed<0
y_speed=0}
#define KeyPress_84
