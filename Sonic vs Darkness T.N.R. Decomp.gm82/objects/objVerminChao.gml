...
if instance_exists(objShieldChao2) && sprite_index!=sprVerminChaoS
sprite_index=sprVerminChaoS
if !instance_exists(objShieldChao2) && sprite_index!=sprVerminChao
sprite_index=sprVerminChao
