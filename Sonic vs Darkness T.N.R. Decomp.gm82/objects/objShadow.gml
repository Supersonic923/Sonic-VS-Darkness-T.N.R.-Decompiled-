...
*/
    ...
    */  
    ...
    wjdelay=false
        ...
        x_speed                 =   0;              // x speed
        top_x_speed             =   10;             // top x speed when running on flat ground
        ...
        roll_decc_factor_up     =   0.2;           // slope deacceleration factor while rolling and going up
        roll_decc_factor_down   =   0.3;           // slope deacceleration factor while rolling and going down
...
*/
    ...
    other_frame         = 0;      // Actual frame on the animation for a different sprite
    ...
    // Intro animation
    animation_intro1_start  = 324;
    animation_intro1_end    = 324;
    animation_intro1_loop   = 324;
    animation_intro1_speed  = 1;
    animation_intro1_repeat = 260;
    animation_intro1_linked_to = "intro2";

    // Intro animation
    animation_intro2_start  = 325;
    animation_intro2_end    = 331;
    animation_intro2_loop   = 325;
    animation_intro2_speed  = 0.2;
    animation_intro2_repeat = 3;
    animation_intro2_linked_to = "intro3";

    // Intro animation
    animation_intro3_start  = 332;
    animation_intro3_end    = 336;
    animation_intro3_loop   = 336;
    animation_intro3_speed  = 0.18;
    ...
    // Intro animation
    animation_intro4_start  = 354;
    animation_intro4_end    = 354;
    animation_intro4_loop   = 354;
    animation_intro4_speed  = 1;
    animation_intro4_repeat = 283;
    animation_intro4_linked_to = "intro5";

    // Intro animation
    animation_intro5_start  = 355;
    animation_intro5_end    = 358;
    animation_intro5_loop   = 358;
    animation_intro5_speed  = 0.3;
    animation_intro5_repeat = -1;
    animation_intro5_linked_to = "intro6";

    // Intro animation
    animation_intro6_start  = 359;
    animation_intro6_end    = 369;
    animation_intro6_loop   = 369;
    animation_intro6_speed  = 0.18;
    animation_intro6_repeat = -1;
    animation_intro6_linked_to = "intro7";

    // Intro animation
    animation_intro7_start  = 370;
    animation_intro7_end    = 381;
    animation_intro7_loop   = 381;
    animation_intro7_speed  = 0.16;
    animation_intro7_repeat = -1;
    animation_intro7_linked_to = "(none)";
    ...
    // Dir animation
    animation_dir_start  = 198;
    animation_dir_end    = 199;
    animation_dir_loop   = 199;
    ...
    // Cannon animation
    animation_cannon_start  = 295;
    animation_cannon_end    = 295;
    animation_cannon_loop   = 295;
    animation_cannon_speed  = 0.16;
    animation_cannon_repeat = true;
    animation_cannon_linked_to = "(none)";

    // Idle waiting animation
    animation_idle_wait_start  = 119;
    animation_idle_wait_end    = 143;
    animation_idle_wait_loop   = 125;
    animation_idle_wait_speed  = 0.16;
    animation_idle_wait_repeat = true;
    animation_idle_wait_linked_to = "(none)";

    // Walking animation
    animation_walking_start  = 6;
    animation_walking_end    = 13;
    animation_walking_loop   = 6;
    animation_walking_speed  = 0.2;
    animation_walking_repeat = true;
    animation_walking_linked_to = "(none)";

    // Joging animation
    animation_joging_start  = 14;
    animation_joging_end    = 21;
    animation_joging_loop   = 14;
    animation_joging_speed  = 0.25;
    animation_joging_repeat = true;
    animation_joging_linked_to = "(none)";

    // Running animation
    animation_running_start  = 26;
    animation_running_end    = 37;
    animation_running_loop   = 26;
    animation_running_speed  = 0.2;
    animation_running_repeat = true;
    animation_running_linked_to = "(none)";

    // Sprinting animation
    animation_sprinting_start  = 62;
    animation_sprinting_end    = 77;//90;
    animation_sprinting_loop   = 62;
    animation_sprinting_speed  = 0.2;
    animation_sprinting_repeat = true;
    animation_sprinting_linked_to = "(none)";

    // Attack animation
    animation_attack_start  = 113;
    animation_attack_end    = 118;
    animation_attack_loop   = 118;
    animation_attack_speed  = 0.2;
    animation_attack_repeat = false;
    animation_attack_linked_to = "(none)";

    // Rolling animation
    animation_rolling_start  = 91;
    animation_rolling_end    = 94;
    animation_rolling_loop   = 91;
    animation_rolling_speed  = 0.55;
    animation_rolling_repeat = true;
    animation_rolling_linked_to = "(none)";

    // Charging animation
    animation_charge_start  = 103;
    animation_charge_end    = 106;
    animation_charge_loop   = 103;
    animation_charge_speed  = 0.4;
    animation_charge_repeat = false;
    animation_charge_linked_to = "spindash";

    // Skidding animation
    animation_skidding_start  = 46;
    animation_skidding_end    = 47;
    animation_skidding_loop   = 46;
    animation_skidding_speed  = 0.2;
    animation_skidding_repeat = true;
    animation_skidding_linked_to = "(none)";

    // Skidding2 animation
    animation_skidding2_start  = 163;
    animation_skidding2_end    = 164;
    animation_skidding2_loop   = 163;
    animation_skidding2_speed  = 0.4;
    animation_skidding2_repeat = true;
    animation_skidding2_linked_to = "(none)";

    // Push animation
    animation_pushing_start  = 171;
    animation_pushing_end    = 178;
    animation_pushing_loop   = 171;
    animation_pushing_speed  = 0.2;
    animation_pushing_repeat = true;
    animation_pushing_linked_to = "(none)";

    // Crouch down animation
    animation_crouchdown_start  = 100;
    animation_crouchdown_end    = 102;
    animation_crouchdown_loop   = 102;
    animation_crouchdown_speed  = 0.15;
    animation_crouchdown_repeat = false;
    animation_crouchdown_linked_to = "(none)";

    // Spindash animation
    animation_spindash_start  = 48;
    animation_spindash_end    = 51;
    animation_spindash_loop   = 48;
    animation_spindash_speed  = 0.4;
    animation_spindash_repeat = true;
    animation_spindash_linked_to = "(none)";

    // Hurt animation
    animation_hurt_start  = 147;
    animation_hurt_end    = 149;
    animation_hurt_loop   = 147;
    animation_hurt_speed  = 0.2;
    animation_hurt_repeat = false;
    animation_hurt_linked_to = "(none)";

    //Jump animation
    animation_jumping_start  = 91;
    animation_jumping_end    = 94;
    animation_jumping_loop   = 91;
    animation_jumping_speed  = 0.40;
    animation_jumping_repeat = true;
    animation_jumping_linked_to = "(none)";

    //Jump 2 animation
    animation_jumping2_start  = 53;
    animation_jumping2_end    = 55;
    animation_jumping2_loop   = 54;
    animation_jumping2_speed  = 0.3;
    animation_jumping2_repeat = true;
    animation_jumping2_repeat_times = -1;
    animation_jumping2_linked_to = "(none)";

    //Jump 3 animation
    animation_jumping3_start  = 312;
    animation_jumping3_end    = 315;
    animation_jumping3_loop   = 312;
    animation_jumping3_speed  = 0.40;
    animation_jumping3_repeat = true;
    animation_jumping3_linked_to = "(none)";

    //Spin Jump animation
    animation_spinjump_start  = 88;
    animation_spinjump_end    = 94;
    animation_spinjump_loop   = 91;
    animation_spinjump_speed  = 0.2;
    animation_spinjump_repeat = true;
    animation_spinjump_linked_to = "(none)";

    //Air Jump animation
    animation_airjump_start  = 91;
    animation_airjump_end    = 94;
    animation_airjump_loop   = 91;
    animation_airjump_speed  = 0.40;
    animation_airjump_repeat = true;
    animation_airjump_linked_to = "(none)";

    //Stomp animation
    animation_stomping_start  = 111;
    animation_stomping_end    = 112;
    animation_stomping_loop   = 111;
    animation_stomping_speed  = 0.4;
    animation_stomping_repeat = true;
    animation_stomping_linked_to = "(none)";

    //Stomp Land animation
    animation_stomp_land_start  = 22;
    animation_stomp_land_end    = 25;
    animation_stomp_land_loop   = 22;
    animation_stomp_land_speed  = 0.16;
    animation_stomp_land_repeat = false;
    animation_stomp_land_linked_to = "(none)";

    // Spring jumping animation
    animation_spring_jump_start  = 269;
    animation_spring_jump_end    = 283;
    animation_spring_jump_loop   = 282;
    ...
    // Corkscrew animation
    animation_corkscrew_start  = 269;
    animation_corkscrew_end    = 279;
    animation_corkscrew_loop   = 269;
    animation_corkscrew_speed  = 0.2;
    animation_corkscrew_repeat = true;
    animation_corkscrew_repeat_times = -1;
    animation_corkscrew_linked_to = "(none)";

    //Hang animation
    animation_hang_start  = 165;
    animation_hang_end    = 168;
    animation_hang_loop   = 165;
    ...
    //Pole animation
    animation_pole_start  = 337;
    animation_pole_end    = 340;
    animation_pole_loop   = 337;
    ...
    //Pole 2 animation
    animation_pole2_start  = 341;
    animation_pole2_end    = 344;
    animation_pole2_loop   = 341;
    ...
    //Airfall animation
    animation_airfall_start  = 53;
    animation_airfall_end    = 55;
    animation_airfall_loop   = 54;
    animation_airfall_speed  = 0.3;
    animation_airfall_repeat = true;
    animation_airfall_repeat_times = -1;
    animation_airfall_linked_to = "(none)";

    //Airfall 2 animation
    animation_airfall2_start  = 58;
    animation_airfall2_end    = 61;
    animation_airfall2_loop   = 59;
    ...
    //Airflight animation
    animation_airflight_start  = 56;
    animation_airflight_end    = 57;
    animation_airflight_loop   = 56;
    ...
    //Ramp animation
    animation_ramp_start  = 284;
    animation_ramp_end    = 294;
    animation_ramp_loop   = 293;
    animation_ramp_speed  = 0.25;
    animation_ramp_repeat = true;
    animation_ramp_repeat_times = -1;
    animation_ramp_linked_to = "(none)";

    //Soaring animation
    animation_soaring_start  = 159;
    animation_soaring_end    = 160;
    animation_soaring_loop   = 159;
    animation_soaring_speed  = 0.3;
    animation_soaring_repeat = true;
    animation_soaring_linked_to = "(none)";

    //Lightdash animation
    animation_lightdash_start  = 144;
    animation_lightdash_end    = 145;
    animation_lightdash_loop   = 144;
    animation_lightdash_speed  = 0.25;
    animation_lightdash_repeat = true;
    animation_lightdash_linked_to = "(none)";

    //Upward Trick
    animation_uptrick_start = 250;
    animation_uptrick_end   = 259;
    animation_uptrick_loop  = 258;
    ...
    //Forward Trick
    animation_righttrick_start = 223;
    animation_righttrick_end   = 233;
    animation_righttrick_loop  = 232;
    animation_righttrick_speed = .3;
    animation_righttrick_repeat = true;
    animation_righttrick_repeat_times = -1;
    animation_righttrick_linked_to = "(none)";

    //Backward Trick
    animation_lefttrick_start = 234;
    animation_lefttrick_end   = 241;
    animation_lefttrick_loop  = 240;
    animation_lefttrick_speed = .3;
    animation_lefttrick_repeat = true;
    animation_lefttrick_linked_to = "(none)";

    //Downkward Trick
    animation_downtrick_start = 242;
    animation_downtrick_end   = 249;
    animation_downtrick_loop  = 248;
    animation_downtrick_speed = .3;
    animation_downtrick_repeat = true;
    animation_downtrick_linked_to = "(none)";

    //RailGrind
    animation_grind_start = 161;
    animation_grind_end   = 162;
    animation_grind_loop  = 161;
...
*/
    ...
    if transform=false{
    var camtrans;
    camtrans=instance_create(x,y,objShadowDie);
...
*/
    ...
    wjdelay=false}
        ...
        if action=action_hang
        {
            ...
            if hang=6
            {
                x=instance_nearest(x,y,objRadRocket).x
                y=instance_nearest(x,y,objRadRocket).y
            }
            if hang=7
            {
                x=instance_nearest(x,y,objRadHeli).x
                y=instance_nearest(x,y,objRadHeli).y
            }
        ...
        if action=action_twirl
        {
            ...
            airb=true
            twirltime=10
            if animation_frame>=316 && animation_frame<320
            {
            ...
            else if animation_frame>=320 && animation_frame<=323
            {
            if animation_direction=1
            twirlguide=1
            else
        ...
        if (instance_exists(objEnemyParent) && abs(x_speed)<1.5 && global.boost<127) && attackdelay=true{
        var eneme;
        var dir;
        ...
        //sound_play(choose(vcSpecialY,snd,vcAttackY,snd,snd))
        ...
        // Straight Shot
        else if abs(x_speed)<1.5 && global.boost<122 && attackdelay=true{
        if attackdelay=true && animation_frame=116{
        objPlayer.rstrenght=1
        objPlayer.hitrumble=30
        if global.boost<122
        ...
        if react=0
        {
            ...
            animation="gresult"
            else if floor(animation_frame)=198 && !instance_exists(objSdwTeleport)
        ...
        if react=1
        {
            ...
            animation="bresult"
            else if floor(animation_frame)=218 && !instance_exists(objSdwTeleport)
            instance_create(x,y,objSdwTeleport)
        }
        ...
        {   
         ...
         || action == action_corkscrew_roll || action=action_rocket  || (action == action_pole_hang && !key_down) ||  (animation="ride" && ridemove=true) ||
         (animation="floating" && player_collision_top_obj(x,y-25,angle,maskMain,objFanAir)=false && player_collision_bottom_obj2(x,y+25,angle,maskMain,objFanAir)=true)))
          && key_action_pressed && (action != action_crouch_down||!key_down) && action != action_spindash && action != action_charge && action != action_sliding
          && action!=action_elevator && action!=action_pipe && action != action_speed_tube && action!=action_siderun && action!=action_enter && animation!="ride2")
          && checknend=false && pauseplay=false && goal=false && !place_meeting(x,y,objTestUnDuck) && jump_lag=0 && animation!="spinjump"
        {
            ...
            if action=action_hang || action=action_swing
            dont=5
            //y-=25
            if action=action_pole
            y_speed=-5
            ...
            sound_play(sndJump);
            sound_play(sndJumpSpin);
            sound_play(choose(snd,snd,vcRJump,vcRJump2))}
            animation="jumping"
        ...
        if ( action == action_look_up )
        {
            ...
            // deactivate
            if ( !key_up_direct && ground == true ) || pauseplay=true
            {
        ...
        if ( action == action_crouch_down )
        {
            ...
            // while the character is crouching down, if the player doesn't pressed the key anymore,
            // deactivate
            if ( !key_down_direct && ground == true ) || pauseplay=true
            {
                if animation_reverse=false{
                animation_flags_finished=false
                animation_end=animation_frame
        ...
        else
        {
            ...
            if ( action == action_crouch_down && key_action_pressed ) && key_down_direct
            {
                ...
                if animation="charge" && animation_frame=106{
                animation_frame=103
                action = action_spindash;}    // set action to spindash
                
//-----------------------------------------------------------------------------------------------------------
if player_collision_main_object(x+x_speed, y, objRailSwirl) = noone{
if !ground
slide=0;
if checkWalls() 
...
*/
        if ( action == action_rolling )
        {
            ...
            if !instance_exists(objRBoost) && cct=false{
        ...
        if action=action_corkscrewdown
        {
            ...
            y_speed=corkspeed
            if animation_direction=1{
            if animation="jumping3"
            angle=-180
            else
            angle=-90}
            else if animation!="jumping3"
            angle=-90
        ...
        else if ( abs(x_speed) >= 4 && (ground == true || action=action_corkscrewdown) && player_collision_main_object(x + x_speed, y, objSwirlPar) != noone )
        {
            ...
            if ( action == action_rolling || animation="jumping3")
...
applies_to=self
*/
    if (instance_exists(objRBoost) || action=action_stomping || action=action_spindash || action=action_charge || abs(x_speed)>5 || abs(y_speed)>5 || homing=1) && instance_exists(objWaterLine) && global.specialfx>1
    {
    if global.underwater=true
        repeat(2)instance_create(x+YLen*4,y-XLen*4,objBoostWater);
    }

    if instance_exists(objRBoost) && invincibility!=1 && global.specialfx>2
    {
...
player_object_handle()/*        //w
        ...
        if (objHandle != noone) && cct=false
        {
            ...
            else
            {
                ...
                || (animation == "homeroll" || animation == "crouch_slide" || animation=="home" || animation="jumping2" || animation="righttrick")
                || invincibility == 1 || invincibility == 3 || homing || shield==3) || instance_exists(objRBoost)
                {
                    // Bounce
        ...
        if (objHandle != noone) && cct=false
        {
            ...
            else
            {
                if (action == action_rolling || action == action_jumping || action == action_spindash || action == action_stomping
                || (animation == "homeroll" || animation == "crouch_slide" || animation=="home" || animation="jumping2" || animation="righttrick")
                || invincibility == 1 || invincibility == 3 || homing=1 || shield==3) || instance_exists(objRBoost)
                {
                    // Bounce
                    if (!ground && y_speed>0) && action!=action_stomping
                    {
        ...
        if (objHandle != noone) && cct=false
        {
            ...
            else
            {
                if (action == action_rolling || action == action_jumping || action == action_spindash || action == action_stomping
                || (animation == "homeroll" || animation == "crouch_slide" || animation=="home" || animation="jumping2" || animation="righttrick")
                || invincibility == 1 || invincibility == 3 || homing=1) || (instance_exists(objRBoost))
                {
                    // Bounce
...
applies_to=self
*/
if (!ground && !homing && animation!="floating") && (action!=action_soaring && action!=action_dive) && (animation!="soaring" || lightdash=false) && action!=action_stomping
&& action!=action_jumping && action!=action_corkscrewdown && action!=action_trick && animation!="ramp" && (animation!="lightdash" || lightdash=false) && animation!="corkscrew"
&& action!=action_pole_hang && action!=action_swing && action!=action_ride && animation!="homejump" && animation!="homejump2" && animation!="homejump3" && animation!="homejump4"
&& action!=action_waterfall && action!=action_cannon
{
    if y_speed>=0 && animation!="walljump" && animation!="homeroll" && (animation!="breath" && animation_frame!=260) && (animation!="flightdash" || !instance_exists(objRBoost)){
        if animation="home" || animation="balloon" || animation="rolling" || animation="hang"
        animation="airfall2";
        else if animation!="airfall2"
        animation="airfall";
        }
    if y_speed<0 && animation!="flightdash" && animation!="walljump" && animation!="home" && animation!="balloon" && animation!="spinjump" && animation!="airjump"
        animation="airflight";
/*
    if y_speed>0 && animation!="walljump" && animation!="homeroll" && (animation!="breath" && animation_frame!=186) && (animation!="flightdash" || !instance_exists(objRBoost))
        animation="airfall";
...
//Boost delay
if boostdelay>0 && !instance_exists(objBoostPar)
    boostdelay-=1
...
|| animation="flightdash" || animation="spinboost" || animation="waterfall2" || animation="waterfall3" || action=action_hang || action=action_sideroll || action=action_siderun || action=action_corkscrewdown || action=action_stomping || action=action_trick
|| animation="spinjump" || action=action_spinjump || speed_sneakers=1 || action=action_dive || abs(x_speed)>11/*animation="sprinting"*/ ) && !instance_exists(objRBoost) && !instance_exists(objBBoostTrail) && path_index!=pathramp1
trail=true
else
trail=false
/*"/*'/**//* YYD ACTION
...
if ground=true
{
            if floor(animation_frame)=9 || floor(animation_frame)=13 || floor(animation_frame)=17 || floor(animation_frame)=21
            || floor(animation_frame)=96
            || floor(animation_frame)=64 || floor(animation_frame)=72 || floor(animation_frame)=27 || floor(animation_frame)=33
            || floor(animation_frame)=299 || floor(animation_frame)=303 || floor(animation_frame)=307 || floor(animation_frame)=311
            {
                if stopstep=true
                {
                    if floor(animation_frame)=64 || floor(animation_frame)=72 || floor(animation_frame)=27 || floor(animation_frame)=33
                    {
                        if floor(animation_frame)=64
                        sound_play(skats1)
                        if floor(animation_frame)=72
                        sound_play(skats2)
                        if floor(animation_frame)=27
                        sound_play(skats1)
                        if floor(animation_frame)=33
                        sound_play(skats2)
                    }
                    else
                    {
    ...
    || animation="waterspout" || animation="crouch_slide" || animation="spinboost" || animation="running" || animation="sprinting")
    {
        if water_skid=0{
    ...
    || action=action_rolling || animation="spinboost" || animation="crouch_slide" || animation="running" || animation="sprinting")
    {
        if water_skid=0{
...
{
    if screwon=false && (floor(animation_frame)=9 || floor(animation_frame)=13 || floor(animation_frame)=17 || floor(animation_frame)=47 || floor(animation_frame)=21
    || (floor(animation_frame)=81 && animation == "walljump" && y_speed=2) || floor(animation_frame)=146) ||
    (floor(animation_frame)=299 || floor(animation_frame)=303 && action=action_siderun) || floor(animation_frame)=307 || floor(animation_frame)=311
    || ((floor(animation_frame)=193 || floor(animation_frame)=196) && pushing=true)
    {
        if stopdust=true
        {
            if floor(animation_frame)=81
            instance_create(x+(16*animation_direction),y-5,objStepDust)
            else if floor(animation_frame)=299 && (action=action_siderun)
            instance_create(x+(8*animation_direction),y-2,objStepDust)
            else if floor(animation_frame)=303 && (action=action_siderun)
            instance_create(x+(8*animation_direction),y-2,objStepDust)
            else if floor(animation_frame)=307 && (action=action_siderun)
            instance_create(x+(8*animation_direction),y-2,objStepDust)
            else if floor(animation_frame)=311 && (action=action_siderun)
            instance_create(x+(8*animation_direction),y-2,objStepDust)
            else
...
if global.intro_pose=1
{
    ...
    animation_intro1_repeat = 445;

    if animation="intro1"
    goal=true
    if animation="intro3" && animation_flags_finished && allow_intro=true{
    animation="idle"
    goal=false
    global.stoptime=false
    }
    else if animation="intro2" && animation_flags_finished
    animation="intro3"
}
else
{
    ...
    if animation="intro4"
    goal=true
    if animation="intro7" && animation_frame+animation_speed>=animation_intro7_end-animation_speed/2//animation_flags_finished
    && allow_intro=true
    {
    animation_skip = 8;
    x_speed=8
...
flipdone2=true
    ...
    if /*animation!="floating" &&*/ action!=action_dive && action!=action_fake_hurt{
    ...
    if action=action_rolling && (key_slide_pressed || global.b_button || player_collision_main_object(x, y, objTestUnDuck)) && abs(x_speed)>1.5
     && checknend=false && goal=false && pauseplay=false && boss_boundary=false && auto_run=false && !player_collision_watr(x,y,angle,objWaterSolid){
    action=action_normal
    ...
    if animation="sprinting" && instance_exists(objBoostPar) && abs(x_speed)>=12
        animation_speed=.25
    ...
    if ( (action == action_normal || action=action_elevator) && ground == true)// && animation!="crouch_slide" && animation!="crouch_slide2"
    {
        ...
        animation="slide";
         ...
         && checknend=false && goal=false && pauseplay=false && animation!="waterspout" && auto_run=false && !player_collision_watr(x,y,angle,objWaterSolid)
          && animation!="crouch_slide2"{
        ...
        && animation="crouch_slide" && checknend=false && goal=false && pauseplay=false && boss_boundary=false && animation!="waterspout" && auto_run=false && !player_collision_watr(x,y,angle,objWaterSolid)
         && animation!="crouch_slide2"{
        if animation!="crouch_slide"{
        animation="crouch_slide"
        global.b_button=false
        ...
        /*else if ( abs(x_speed) > 0 && abs(x_speed) <= 1.5 && animation != "walking" && animation != "crouch_slide2")
            animation = "walking";
        else if ( abs(x_speed) > 1.5 && abs(x_speed) <= 4 && animation != "joging" && animation != "crouch_slide2")
            animation = "joging";
        else if ( abs(x_speed) > 4 && abs(x_speed) <= 11 && animation != "running" && animation != "crouch_slide2")
            animation = "running";
        else if ( abs(x_speed) > 11 && animation != "sprinting" && animation!="spinboost" && animation != "crouch_slide2")
            animation = "sprinting";*/
        //Walking
        else if ( abs(x_speed) > 0 && abs(x_speed) <= 1.5 && animation != "walking" && animation!="spinboost" && animation!="crouch_slide" && animation != "crouch_slide2"){
                if animation="joging"
                {
        ...
        //Joging
        else if ( abs(x_speed) > 1.5 && abs(x_speed) <= 4 && animation != "joging" && animation!="spinboost" && animation!="crouch_slide" && animation != "crouch_slide2"){
        ...
        //Running
        else if ( abs(x_speed) > 4 && abs(x_speed) <= 11 && animation != "running" && animation!="spinboost" && animation!="crouch_slide" && animation != "crouch_slide2"){
        ...
        //Sprinting
            ...
            animation = "sprinting";}
        else if ( x_speed == 0 && animation != "idle" && animation != "idle_wait" && animation!="attack" && animation != "fallingfront" && animation != "fallingback" && animation != "gresult" && animation != "bresult" &&
        animation != "stomp_land" && animation!="crouch_slide" && animation != "crouch_slide2" && animation!="dir" && (animation != "intro1" && animation != "intro2" && animation != "intro3" &&
        animation != "intro4" && animation != "intro5" && animation != "intro6" && animation != "intro7")){
            animation = "idle";}
        ...
        if ( action == action_jumping && (animation != "jumping3" && animation != "parkour" && animation!="spinjump" && animation!="airjump") || (animation = "airfall2" && y_speed>0))
            animation = "jumping";
        ...
        if (action == action_corkscrew && animation != "corkscrew")
            animation = "corkscrew";
        if (action == action_corkscrewdown && animation != "side_run" && animation != "jumping3")
            animation = "side_run";
        ...
        if ( action == action_shield && shield == 4 && animation != "jumping" )
            animation = "jumping";
        if ( action == action_grind && animation != "grind" && animation != "corkscrew")
            animation = "grind";
        if ( action == action_walljump && animation != "walljump" )
            animation = "walljump";
        if ( action == action_spinjump && animation != "jumping" )
            animation = "jumping";
        ...
        if ( action == action_sideroll && animation != "homeroll" )
            animation = "homeroll";
        if ( action == action_siderun && animation != "side_run" && animation != "side_run2" && animation!= "jumping3" )
            animation = "side_run";
...
if animation_frame=118 || animation_frame=25
animation="idle"
if animation="stomp_land" && animation_flags_finished
animation="idle"
if floor(animation_frame)>=91 && animation="spinjump"
animation_speed=.4
...
*/
    ...
    */
    ...
    if ( animation != animation_previous ) || animation_reset=true
    {
        ...
        player_sprite=sprShadowSwing
        else
        player_sprite=sprShadow
...
*/
        ...
        if (homing=1 || animation="homeroll") && cct=false && global.specialfx=2
...
applies_to=self
*/
if !keyboard_check(ord('D')) && cct=true
cct=false
/*"/*'/**//* YYD ACTION
lib_id=1
action_id=605
...
// Get angle of the animation
    if (ground || action!=action_normal || lightdash=true || slide=1 || path_index!=-1)
    {
...
if hurt!=0
draw_sprite_general(sprShadow, floor(animation_frame)+floor(animation_frame2),0,0,sprite_width,sprite_height,floor(x) - lengthdir_x(32, 0)*animation_direction + lengthdir_y(37, 0)*animation_direction
...
/*draw_sprite_general(sprSonic,floor(animation_frame),(i.x-x)+32,0,sprite_width,sprite_height,floor(x) - 32*animation_direction
,floor(i.y)+ 37,animation_direction,
-1,angle,c_black,c_black,c_black,c_white,1-(i.y-(y+20))/20)*/
...
*/
    ...
    if player_sprite=sprShadowSwing{
    if view_current=0
    other_frame+=.25
    animation_frame=other_frame}
        ...
        // Chaos Control FX
        if floor(animation_frame)>=355 && floor(animation_frame)<358
        draw_sprite_blend_ext(sprCCShadow, floor(animation_frame)-355, floor(x), floor(y), animation_direction, abs(animation_direction), floor(animation_angle), image_blend, hurt, bm_add);
    ...
    else if animation!="cannon"
    {
        ...
        draw_sprite_ext(sprShield3, (global.motion_time div 50)*2+1, floor(x), floor(y),1,1,0,c_white,.4);
        draw_sprite_ext(sprShadowShield, (global.motion_time div 50)*1.5, floor(x), floor(y),1,1,0,c_white,1);
        draw_set_blend_mode(bm_normal)}
...
applies_to=self
invert=0
arg0=allowtransform=true && global.player="Shado"  && global.online_mode=true
*/
/*"/*'/**//* YYD ACTION
lib_id=1
action_id=422
...
applies_to=self
*/
/*if //global.use17=true &&
global.boost<127 && cct=true{
cct=false
instance_create(x,y,objSdwTeleport)}
...
applies_to=self
invert=0
arg0=checknend=false && action!=action_speed_tube && action!=action_elevator && goal=false && (global.HUB=false || room=rmHUB) && pauseplay=false && cct=false && !player_collision_main_object(x, y, objTestUnDuck) && homing=0 && nomovet=0 && no_boost=false && nomove=false
*/
/*"/*'/**//* YYD ACTION
lib_id=1
action_id=603
...
applies_to=self
invert=0
arg0=checknend=false && action!=action_elevator && goal=false && (global.HUB=false || room=rmHUB) && pauseplay=false && shield!=4
*/
/*"/*'/**//* YYD ACTION
lib_id=1
action_id=408
