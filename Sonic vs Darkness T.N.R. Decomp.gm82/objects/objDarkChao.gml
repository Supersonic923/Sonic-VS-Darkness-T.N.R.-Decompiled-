...
if instance_exists(objShieldChao2) && sprite_index!=sprDarkChaoS
sprite_index=sprDarkChaoS
if !instance_exists(objShieldChao2) && sprite_index!=sprDarkChao
sprite_index=sprDarkChao
