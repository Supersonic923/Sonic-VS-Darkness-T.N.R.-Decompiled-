...
if instance_exists(objShieldChao) && sprite_index!=sprSonicChaoS
sprite_index=sprSonicChaoS
if !instance_exists(objShieldChao) && sprite_index!=sprSonicChao
sprite_index=sprSonicChao
