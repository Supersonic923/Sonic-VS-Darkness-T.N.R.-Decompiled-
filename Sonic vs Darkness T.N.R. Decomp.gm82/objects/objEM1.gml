...
if global.emeralds[0]>0 || global.online_mode=true || global.time_attack=true
instance_destroy()
...
draw_sprite_ext(sprEM1S,0,x,y,1,1,0,c_white,alph)
draw_set_blend_mode(bm_normal)
draw_sprite(sprite_index,image_index,x,y)

draw_set_blend_mode(bm_add)
if global.specialfx>1
draw_sprite_ext(sprEM1S,1,x,y,1,1,0,c_white,alph)
draw_set_blend_mode(bm_normal)
