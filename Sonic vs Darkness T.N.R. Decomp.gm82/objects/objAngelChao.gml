...
if instance_exists(objShieldChao) && sprite_index!=sprAngelChaoS
sprite_index=sprAngelChaoS
if !instance_exists(objShieldChao) && sprite_index!=sprAngelChao
sprite_index=sprAngelChao
