...
if global.emeralds[3]>0 || global.online_mode=true || global.time_attack=true
instance_destroy()
else if !instance_exists(objEmeraldSound)
instance_create(x,y,objEmeraldSound)
#define Alarm_0
/*"/*'/**//* YYD ACTION
lib_id=1
action_id=603
...
v.image_blend=c_green}

global.emeralds[3]=4

sound_play(sndEmeraldGet)}
...
draw_sprite_ext(sprEM4S,0,x,y,1,1,0,c_white,alph)
draw_set_blend_mode(bm_normal)
draw_sprite(sprite_index,image_index,x,y)

draw_set_blend_mode(bm_add)
if global.specialfx>1
draw_sprite_ext(sprEM4S,1,x,y,1,1,0,c_white,alph)
draw_set_blend_mode(bm_normal)
