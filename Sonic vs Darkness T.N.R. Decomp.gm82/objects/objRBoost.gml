...
applies_to=self
*/
if global.hyperboost>0 || global.player="Supershadow"{
...
else if sprite_index!=sprRBoost{
sprite_index=sprRBoost
cul=c_white
if instance_exists(objBBoostTrail){
objBBoostTrail.c1 = c_red
objBBoostTrail.c2 = c_orange}
if instance_exists(objRBoostTrail){
objBBoostTrail.c1 = c_red
objBBoostTrail.c2 = c_orange}
}
